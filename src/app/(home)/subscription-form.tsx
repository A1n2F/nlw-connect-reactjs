...
type SubscribeSchema = z.infer<typeof subscriptionSchema>

export function SubscriptForm() {
    const { register, handleSubmit, formState: { errors } } = useForm<SubscribeSchema>({
      resolver: zodResolver(subscriptionSchema)
    })

    function onSubscribe(data: SubscribeSchema) {
      console.log(data)
    }
